...
/*----------------------------------------------------------
1. Um formulário com três campos do tipo number com os ids: x, y, z e um botão chamado Ordenar

2. Ao clicar no botão (no JQuery):
Capturar os três valores digitados
Converter os valores para números inteiros
Exibir os valores em ordem crescente
Mostrar também qual variável corresponde a cada valor
